export const admissionsViewTemplates = {
    "Dashboard": (role = "Admissions") => `
        <div class="view-header">
            ...
            <p style="color: var(--slate); font-size: 0.8rem; margin-top: 5px;">Institutional Intake Intelligence &bull; Session 2026-27 &nbsp;|&nbsp; <span style="color: #64ffda;">Quantum Sync Active</span></p>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 30px; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));">
            <div class="kpi-card">
                ...
                <span class="kpi-val" style="color: #64ffda;">32.4%</span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">↑ 5.2% Momentum</div>
            </div>
            <div class="kpi-card">
            ...
            <div class="kpi-card">
                ...
                <span class="kpi-val" style="color: #ffab00;">86</span>
                <div style="font-size: 0.65rem; color: #ffab00; font-weight: 700;">SLA: 1.2 hrs remaining</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">App. Fee Revenue</span>
                <span class="kpi-val" style="color: var(--gold);">$124.5K</span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">102% of projection</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Enrolment Velocity</span>
                <span class="kpi-val">12.4 <span style="font-size: 0.8rem; opacity: 0.5;">/ day</span></span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">Steady Progression</div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 20px;" class="slide-up">
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 8px;">
                    <div style="background: rgba(100,255,218,0.1); padding: 12px; border-radius: 8px; border-left: 4px solid #64ffda; display: flex; justify-content: space-between; align-items: center;">
                        <div><span style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">INQUIRIES</span><div style="font-size: 1.2rem; font-weight: 900;">4,240</div></div>
                    ...
                    <div style="background: rgba(184,134,11,0.1); padding: 12px; border-radius: 8px; border-left: 4px solid var(--gold); display: flex; justify-content: space-between; align-items: center; width: 90%; margin: 0 auto;">
                        <div><span style="font-size: 0.65rem; color: var(--gold); font-weight: 700;">APPLICATIONS</span><div style="font-size: 1.2rem; font-weight: 900;">1,842</div></div>
                        <div style="text-align: right; font-size: 0.7rem; color: var(--gold);">43.4% Yield</div>
                    </div>
                    <div style="text-align: center; color: var(--slate); font-size: 0.8rem; line-height: 1;">▼</div>
                    <div style="background: rgba(100,255,218,0.05); padding: 12px; border-radius: 8px; border-left: 4px solid #64ffda; display: flex; justify-content: space-between; align-items: center; width: 80%; margin: 0 auto;">
                        <div><span style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">VERIFIED</span><div style="font-size: 1.2rem; font-weight: 900;">812</div></div>
                        <div style="text-align: right; font-size: 0.7rem; color: #64ffda;">44.1% Review</div>
                    </div>
                    <div style="text-align: center; color: var(--slate); font-size: 0.8rem; line-height: 1;">▼</div>
                    <div style="background: rgba(184,134,11,0.2); padding: 12px; border-radius: 8px; border-left: 4px solid var(--gold); display: flex; justify-content: space-between; align-items: center; width: 70%; margin: 0 auto;">
                        <div><span style="font-size: 0.65rem; color: var(--gold); font-weight: 700;">ENROLLED</span><div style="font-size: 1.2rem; font-weight: 900; color: var(--gold);">540</div></div>
                        <div style="text-align: right; font-size: 0.7rem; color: var(--gold);">66.5% Close</div>
                    </div>
                </div>
            </div>
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 15px;">
                    ...
                    <div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.7rem; margin-bottom: 5px;">
                            <span style="font-weight: 700;">MBA Strategy & Finance</span><span style="color: #64ffda; font-weight: 800;">310/500</span>
                        </div>
                        <div style="height: 10px; background: rgba(255,255,255,0.05); border-radius: 5px; overflow: hidden; border: 1px solid rgba(255,255,255,0.1);">
                            <div style="width: 62%; height: 100%; background: linear-gradient(90deg, #64ffda, #00fa9a); box-shadow: 0 0 10px rgba(100,255,218,0.5);"></div>
                        </div>
                    </div>
                    <div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.7rem; margin-bottom: 5px;">
                    ...
                    <div style="margin-top: 10px; padding: 15px; background: rgba(100,255,218,0.03); border-radius: 10px; border: 1px dashed rgba(100,255,218,0.2);">
    ...
    "SIS": (role = "Admissions") => `
        <div class="view-header" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button class="login-btn action-trigger" data-action="new_applicant" style="width: auto; padding: 10px 25px; background: var(--gold); color: var(--navy-dark); font-weight: 800; border: none;">+ NEW_APPLICANT</button>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 15px; margin-top: 25px;">
            ...
            <div class="kpi-card" style="padding: 15px;">
                ...
                <span class="kpi-val" style="font-size: 1.5rem; color: #64ffda;">450</span>
            </div>
            <div class="kpi-card" style="padding: 15px;">
            ...
            <table class="data-table" style="font-size: 0.72rem;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Mr. Rajan</td>
                        <td><button class="login-btn action-trigger" data-action="seat_offer" style="padding:4px 8px;font-size:0.58rem;width:auto;background:var(--gold);color:var(--navy-dark);">OFFER_SEAT</button></td>
                    </tr>
                    <tr>
                        <td>#L-9851</td>
                    ...
                    <tr>
                        ...
                        <td>M.Tech AI</td>
                        <td style="font-weight:800;color:#64ffda;">88.2</td>
                        <td><span class="status-pill status-verified">VERIFIED</span></td>
                        <td>Mr. Arjun</td>
                        <td><button class="login-btn action-trigger" data-action="seat_offer" style="padding:4px 8px;font-size:0.58rem;width:auto;background:var(--gold);color:var(--navy-dark);">OFFER_SEAT</button></td>
                    </tr>
    ...
    "Reports": (role = "Admissions") => `
        ...
        <div style="display: grid; grid-template-columns: 1fr 1.5fr; gap: 25px; margin-top: 25px;" class="slide-up">
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                <h3 style="font-size: 0.9rem; font-weight: 700; color: var(--gold); margin-bottom: 20px;">Download Center</h3>
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <button class="login-btn action-trigger" data-action="export_pdf" style="text-align: left; padding: 15px; font-size: 0.75rem;">⏬ Daily Lead Summary (Feb 23)</button>
                    <button class="login-btn action-trigger" data-action="export_excel" style="text-align: left; padding: 15px; font-size: 0.75rem;">⏬ Program-wise Funnel Report</button>
                    <button class="login-btn action-trigger" data-action="export_csv" style="text-align: left; padding: 15px; font-size: 0.75rem;">⏬ Counsellor Performance Metrics</button>
                </div>
            </div>
            <div style="background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
