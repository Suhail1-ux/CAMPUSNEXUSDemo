...
export const facultyViewTemplates = {
    "Dashboard": (role = "Faculty") => `
        <div class="view-header">
            ...
            <p style="color: var(--slate); font-size: 0.8rem; margin-top: 5px;">Academic Session 2026-27 &nbsp;|&nbsp; <span style="color: #64ffda;">Curriculum Node: Synchronized</span></p>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 30px;">
            ...
            <div class="kpi-card">
                ...
                <span class="kpi-val" style="color: #64ffda;">96.2%</span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">↑ 2.1% vs Prev Month</div>
            </div>
            <div class="kpi-card">
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 25px; margin-top: 25px;" class="slide-up">
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
                    <h3 style="font-size: 0.9rem; font-weight: 700;">Student Engagement Pulse</h3>
                    <div style="display: flex; gap: 15px;">
                        <span style="font-size: 0.7rem; color: var(--slate);"><i style="color: var(--gold); margin-right: 5px;">●</i>Participation</span>
                        <span style="font-size: 0.7rem; color: var(--slate);"><i style="color: #64ffda; margin-right: 5px;">●</i>Assessment Node</span>
                    </div>
                </div>
                <div style="height: 250px; background: rgba(0,0,0,0.2); border-radius: 12px; border: 1px dashed var(--glass-border); position: relative; overflow: hidden; display: flex; align-items: flex-end;">
                    <svg width="100%" height="100%" viewBox="0 0 1000 300" preserveAspectRatio="none" style="position: absolute; bottom: 0; left: 0;">
                        <path d="M0,200 Q200,50 400,180 T800,100 T1000,150 V300 H0 Z" fill="rgba(184,134,11,0.1)" stroke="var(--gold)" stroke-width="2" />
                        <path d="M0,240 Q200,210 400,230 T800,190 T1000,210 V300 H0 Z" fill="rgba(100,255,218,0.05)" stroke="#64ffda" stroke-width="2" opacity="0.6" />
                    </svg>
            ...
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                <h3 style="font-size: 0.9rem; font-weight: 700; margin-bottom: 20px;">Faculty Quick Links</h3>
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div class="action-card action-trigger" data-action="mark_attendance" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:15px; background:rgba(255,255,255,0.03); border-radius:10px; border:1px solid var(--glass-border);">
                        <i style="font-size:1.5rem; color:var(--gold);">📋</i>
                        <div>
                            <span style="font-size:0.75rem; font-weight:800; display:block;">Quick Attendance Scan</span>
                            <span style="font-size:0.6rem; color:var(--slate);">Select Class & Sync Nodes</span>
                        </div>
                    </div>
                    <div class="action-card action-trigger" data-action="upload_resource" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:15px; background:rgba(255,255,255,0.03); border-radius:10px; border:1px solid var(--glass-border);">
                        <i style="font-size:1.5rem; color:var(--gold);">📤</i>
                        <div>
                            <span style="font-size:0.75rem; font-weight:800; display:block;">Push Lesson Plan</span>
                            <span style="font-size:0.6rem; color:var(--slate);">Upload to SIS Resource Hub</span>
                        </div>
                    </div>
                    <div class="action-card action-trigger" data-action="publish_results" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:15px; background:rgba(100,255,218,0.05); border-radius:10px; border:1px solid rgba(100,255,218,0.2);">
                        <i style="font-size:1.5rem; color:var(--gold);">🚀</i>
                        <div>
                            <span style="font-size:0.75rem; font-weight:800; display:block; color:var(--gold);">Release Marks Registry</span>
    ...
    "Academics": () => `
        <div class="view-header">
            <h1 class="page-title" style="font-size: 1.8rem; font-weight: 800; color: var(--gold);">Academic Node Matrix</h1>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 25px;" class="slide-up">
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 12px; border: 1px solid var(--glass-border);">
                ...
                <div style="margin-top: 20px;">
                    ...
                    <div style="height: 4px; background: rgba(255,255,255,0.05); border-radius: 2px; overflow: hidden;">
                        <div style="width: 42%; height: 100%; background: #64ffda;"></div>
                    </div>
                </div>
                <button class="login-btn action-trigger" data-action="view_course" style="margin-top: 20px; font-size: 0.7rem; width: 100%;">ACCESS_COURSE_FORUM</button>
            </div>
    ...
    "Attendance": () => `
        <div class="view-header">
            <h1 class="page-title" style="font-size: 1.8rem; font-weight: 800; color: var(--gold);">Instructional Attendance Node</h1>
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 20px; border-radius: 12px; display: flex; gap: 15px; border: 1px solid var(--glass-border);">
                ...
                <button class="login-btn action-trigger" data-action="sync_attendance" style="width: auto; padding: 8px 25px; font-size: 0.75rem; background: var(--gold); color: var(--navy-dark);">COMMIT_TO_LEDGER</button>
            </div>
        </div>
        ...
        <div class="slide-up" style="margin-top: 25px; background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
            <table class="data-table" style="font-size: 0.75rem;">
                <thead>
                    <tr><th>Scholar Node</th><th>ID</th><th>Program Node</th><th>Status</th><th>Override Logic</th></tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><button class="login-btn" style="padding:4px 10px; font-size:0.55rem; width:auto; background:rgba(100,255,218,0.1); color:#64ffda; border-color:#64ffda;">PRESENT</button></td>
                    </tr>
                    <tr>
                        <td>
                            <div style="display: flex; align-items: center; gap: 10px;">
    ...
    "Reports": () => `
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 25px;" class="slide-up">
            <div class="kpi-card">
                ...
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">↑ 5.2% vs Target</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Student Success Node</span>
        ...
        <div class="slide-up" style="margin-top: 25px; background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                ...
                <div>
                    ...
                    <div style="height: 6px; background: rgba(255,255,255,0.05); border-radius: 3px; overflow: hidden;">
                        <div style="width: 72%; height: 100%; background: #64ffda;"></div>
                    </div>
                </div>
            </div>
