...
export const viewTemplates = {
    "Dashboard": (role = "Management") => `
        <div class="view-header">
            ...
            <p style="color: var(--slate); font-size: 0.8rem; margin-top: 5px;">Institutional Overview for Academic Year 2026-27 &nbsp;|&nbsp; <span style="color: #10b981;">All Systems Operational</span></p>
        </div>
        
        <div class="kpi-grid" style="margin-top: 30px;">
            <div class="kpi-card glass-card">
                <span class="kpi-label">Total Enrollment</span>
                <span class="kpi-val" style="color: var(--white);">${globalStats.Students}</span>
                <div style="font-size: 0.65rem; color: var(--gold); font-weight: 700;">↑ 12% Growth</div>
            </div>
            <div class="kpi-card glass-card">
                <span class="kpi-label">Active Faculty</span>
                <span class="kpi-val" style="color: var(--white);">${globalStats.Faculty}</span>
                <div class="status-pill success" style="margin-top: 5px;">Optimal Utilization</div>
            </div>
            <div class="kpi-card glass-card">
                <span class="kpi-label">Current Applications</span>
                <span class="kpi-val" style="color: var(--white);">${globalStats.Admissions}</span>
                <div class="status-pill warning" style="margin-top: 5px;">450 Pending Docs</div>
            </div>
            <div class="kpi-card glass-card">
                <span class="kpi-label">Revenue YTD</span>
                <span class="kpi-val" style="color: var(--white);">${globalStats.Revenue}</span>
                <div style="font-size: 0.65rem; color: var(--gold); font-weight: 700;">↑ 8% vs Prev Year</div>
            </div>
            <div class="kpi-card glass-card">
                <span class="kpi-label">Avg Attendance</span>
                <span class="kpi-val" style="color: var(--white);">94.2%</span>
                <div style="font-size: 0.65rem; color: #10b981; font-weight: 700;">Above 90% Target</div>
            </div>
            <div class="kpi-card glass-card">
                <span class="kpi-label">Open Grievances</span>
                <span class="kpi-val" style="color: #ef4444;">18</span>
                <div style="font-size: 0.65rem; color: #ef4444; font-weight: 700;">Requires Attention</div>
            </div>
            <div class="kpi-card glass-card">
                <span class="kpi-label">Active Campuses</span>
                <span class="kpi-val" style="color: #10b981;">3</span>
            ...
            <div class="kpi-card glass-card">
                ...
                <div style="font-size: 0.65rem; color: #f59e0b; font-weight: 700;">$1.24M Receivable</div>
            </div>
        </div>
            ...
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
                    ...
                    <div style="display: flex; gap: 15px;">
                        ...
                        <span style="font-size: 0.7rem; color: var(--slate);"><i style="color: #10b981; margin-right: 5px;">●</i>Postgraduate</span>
                    </div>
                </div>
                <div style="height: 250px; background: rgba(0,0,0,0.2); border-radius: 12px; border: 1px dashed var(--glass-border); position: relative; overflow: hidden; display: flex; align-items: flex-end;">
                    ...
                    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
                        <div style="font-size: 3rem; font-weight: 900; color: var(--white); text-shadow: 0 0 30px rgba(184,134,11,0.3);">92.4%</div>
                        <div style="font-size: 0.65rem; color: var(--gold); letter-spacing: 3px; font-weight: 800;">ENROLLMENT_VELOCITY</div>
                    </div>
                </div>
            </div>
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div style="padding: 15px; background: rgba(15, 23, 42, 0.03); border-radius: 10px; border-left: 4px solid var(--gold);">
                    ...
                    <div style="padding: 15px; background: rgba(245, 158, 11, 0.03); border-radius: 10px; border-left: 4px solid #f59e0b;">
                    ...
                    <div style="padding: 15px; background: rgba(239, 68, 68, 0.05); border-radius: 10px; border-left: 4px solid #ef4444;">
                        <p style="font-size: 0.75rem; font-weight: 600; color: #ef4444;">18 Open Grievances</p>
            ...
            <div style="background: var(--glass); padding: 28px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 14px;">
                    <div>
                        ...
                        <div style="height: 5px; background: rgba(15, 23, 42, 0.05); border-radius: 3px;"><div style="width: 94%; height: 100%; background: linear-gradient(90deg, var(--gold), #10b981); border-radius: 3px;"></div></div>
                    </div>
                    <div>
            ...
            <div style="background: var(--glass); padding: 28px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div style="display: flex; gap: 12px; align-items: flex-start;">
                        <div style="width: 8px; height: 8px; background: #10b981; border-radius: 50%; margin-top: 5px; flex-shrink: 0; box-shadow: 0 0 8px #10b981;"></div>
                        <div><p style="font-size: 0.72rem; font-weight: 600;">Fee challan generated — Aarav M.</p><p style="font-size: 0.6rem; color: var(--slate);">2 min ago · Finance</p></div>
                    </div>
                    <div style="display: flex; gap: 12px; align-items: flex-start;">
                    ...
                    <div style="display: flex; gap: 12px; align-items: flex-start;">
                        ...
                        <div><p style="font-size: 0.72rem; font-weight: 600;">Payroll disbursed — Feb 2026 Cycle</p><p style="font-size: 0.6rem; color: var(--slate);">Yesterday · HRMS</p></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border); margin-top: 25px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(6, 1fr); gap: 12px;">
                <button class="nav-item" data-view="Admissions" style="flex-direction: column; padding: 16px 10px; gap: 8px; text-align: center; font-size: 0.65rem; color: var(--gold); border-color: rgba(255,171,0,0.2);">
                    <i data-lucide="user-plus" style="width: 20px; height: 20px;"></i>Admissions
                </button>
                <button class="nav-item" data-view="SIS" style="flex-direction: column; padding: 16px 10px; gap: 8px; text-align: center; font-size: 0.65rem;">
                    <i data-lucide="users" style="width: 20px; height: 20px;"></i>Students
                </button>
                <button class="nav-item" data-view="Exams" style="flex-direction: column; padding: 16px 10px; gap: 8px; text-align: center; font-size: 0.65rem;">
                    <i data-lucide="file-edit" style="width: 20px; height: 20px;"></i>Exams
                </button>
                <button class="nav-item" data-view="Fees" style="flex-direction: column; padding: 16px 10px; gap: 8px; text-align: center; font-size: 0.65rem;">
                    <i data-lucide="dollar-sign" style="width: 20px; height: 20px;"></i>Fees
                </button>
                <button class="nav-item" data-view="Reports" style="flex-direction: column; padding: 16px 10px; gap: 8px; text-align: center; font-size: 0.65rem;">
                    <i data-lucide="file-text" style="width: 20px; height: 20px;"></i>Reports
                </button>
                <button class="nav-item" data-view="Settings" style="flex-direction: column; padding: 16px 10px; gap: 8px; text-align: center; font-size: 0.65rem;">
                    <i data-lucide="settings" style="width: 20px; height: 20px;"></i>Settings
                </button>
            </div>
        </div>
    `,
    "SIS": () => `
        <div class="view-header">
            ...
            <div style="margin-top: 20px; background: var(--glass); padding: 14px 18px; border-radius: 12px; display: flex; gap: 10px; align-items: center; border: 1px solid var(--glass-border);">
                <select class="login-input" style="width: 130px; flex-shrink: 0;"><option>All Campuses</option><option>Main Campus</option><option>City Campus</option><option>North Campus</option></select>
                <select class="login-input" style="width: 105px; flex-shrink: 0;"><option>AY 2026-27</option><option>AY 2025-26</option></select>
                <select class="login-input" style="width: 130px; flex-shrink: 0;"><option>All Programs</option><option>B.Tech CS</option><option>MBA Finance</option><option>B.Com</option><option>Ph.D</option></select>
                <select class="login-input" style="width: 95px; flex-shrink: 0;"><option>All Years</option><option>Year 1</option><option>Year 2</option><option>Year 3</option><option>Year 4</option></select>
                <input type="text" placeholder="Search Scholar ID / Name..." style="background: rgba(255,255,255,0.05); border: 1px solid var(--glass-border); border-radius: 8px; color: var(--white); font-family: Inter, sans-serif; font-size: 0.7rem; padding: 7px 12px; outline: none; flex: 1; min-width: 0;" />
                <button class="login-btn action-trigger" data-action="export_pdf" style="width: auto; padding: 7px 14px; font-size: 0.7rem; white-space: nowrap; flex-shrink: 0; background: var(--gold); color: white;"><i data-lucide="download" style="width:12px; height:12px; vertical-align:middle; margin-right:4px;"></i> PDF</button>
                <button class="login-btn action-trigger" data-action="export_excel" style="width: auto; padding: 7px 14px; font-size: 0.7rem; white-space: nowrap; flex-shrink: 0;"><i data-lucide="download" style="width:12px; height:12px; vertical-align:middle; margin-right:4px;"></i> EXCEL</button>
            </div>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 26px; grid-template-columns: repeat(6, 1fr); gap: 14px;">
            ...
            <div class="kpi-card glass-card" style="padding: 18px;">
                <span class="kpi-label">Avg Attendance</span>
                <span class="kpi-val" style="font-size: 1.8rem; color: #10b981;">94.2%</span>
                <div style="font-size: 0.6rem; color: #10b981; margin-top: 4px;">Above 90% threshold</div>
            </div>
        ...
        <div style="display: flex; gap: 8px; margin-top: 22px; margin-bottom: 16px;">
            <button class="login-btn" style="font-size: 0.7rem; padding: 7px 16px; width: auto; background: var(--gold); color: white;">All Students</button>
            <button class="login-btn" style="font-size: 0.7rem; padding: 7px 16px; width: auto; background: rgba(16, 185, 129, 0.1); color: #10b981; border-color: rgba(16, 185, 129, 0.2);">✓ Active</button>
            <button class="login-btn" style="font-size: 0.7rem; padding: 7px 16px; width: auto; background: rgba(255,77,77,0.08); color: #ff4d4d; border-color: rgba(255,77,77,0.3);"><i data-lucide="alert-triangle" style="width:12px; height:12px; vertical-align:middle; margin-right:4px;"></i> Att. Defaulters</button>
            <button class="login-btn" style="font-size: 0.7rem; padding: 7px 16px; width: auto; background: rgba(255,171,0,0.08); color: #ffab00; border-color: rgba(255,171,0,0.3);"><i data-lucide="credit-card" style="width:12px; height:12px; vertical-align:middle; margin-right:4px;"></i> Fee Pending</button>
            <button class="login-btn" style="font-size: 0.7rem; padding: 7px 16px; width: auto; background: rgba(255,255,255,0.05); color: var(--slate);"><i data-lucide="sun" style="width:12px; height:12px; vertical-align:middle; margin-right:4px;"></i> On Leave</button>
        </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="white-space:nowrap;">
                                <button class="profile-trigger" data-id="#CN-9822" style="display:inline-block;padding:3px 9px;font-size:0.58rem;font-weight:700;border-radius:6px;border:1px solid rgba(184,134,11,0.4);background:rgba(184,134,11,0.1);color:var(--gold);cursor:pointer;margin-right:3px;font-family:inherit;letter-spacing:1px;">VIEW</button>
                                <button class="action-trigger" data-action="download_id" style="display:inline-block;padding:3px 9px;font-size:0.58rem;font-weight:700;border-radius:6px;border:1px solid rgba(16, 185, 129, 0.3);background:rgba(16, 185, 129, 0.1);color:#10b981;cursor:pointer;font-family:inherit;letter-spacing:1px;">ID</button>
                            </td>
                        </tr>
                        <tr>
    ...
    "Admissions": () => `
        <div class="view-header">
            ...
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 18px 22px; border-radius: 12px; display: flex; gap: 12px; align-items: center; border: 1px solid var(--glass-border);">
                <select class="login-input" style="width: auto; height: 38px;"><option>AY 2026-27</option><option>AY 2025-26</option></select>
                <select class="login-input" style="width: auto; height: 38px;"><option>All Campuses</option><option>Main Campus</option><option>City Campus</option><option>North Campus</option></select>
                <select class="login-input" style="width: auto; height: 38px;"><option>All Programs</option><option>B.Tech CS</option><option>MBA Finance</option><option>B.Com</option><option>Ph.D</option></select>
                <select class="login-input" style="width: auto; height: 38px;"><option>All Stages</option><option>Lead</option><option>In Review</option><option>Verified</option><option>Offered</option><option>Converted</option></select>
                ...
                <button class="login-btn action-trigger" data-action="export_excel" style="width: auto; padding: 8px 18px; font-size: 0.72rem; background: var(--gold); color: white; white-space: nowrap;"><i data-lucide="download" style="width:12px; height:12px; margin-right:4px;"></i> EXPORT</button>
            </div>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 28px; grid-template-columns: repeat(6, 1fr); gap: 14px;">
            ...
            <div class="kpi-card" style="padding: 18px; background: rgba(100,255,218,0.05); border-color: rgba(100,255,218,0.25);">
                ...
                <span class="kpi-val" style="font-size: 1.8rem; color: #10b981;">$1.2M</span>
                <div style="font-size: 0.6rem; color: #10b981; margin-top: 4px;">Verified deposits only</div>
            </div>
        </div>
    ...
    "Academics": () => `
        <div class="view-header">
            ...
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 20px; border-radius: 12px; display: flex; gap: 15px; border: 1px solid var(--glass-border);">
                ...
                <button class="login-btn" style="width: auto; padding: 8px 20px; font-size: 0.75rem; background: var(--gold); color: white;"><i data-lucide="download" style="width:14px; height:14px; margin-right:4px;"></i> EXPORT_CATALOG</button>
            </div>
        </div>
        ...
        <div class="slide-up" style="margin-top: 25px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 25px;">
                <div class="glass-card" style="padding: 22px; border-radius: 14px; border-top: 3px solid var(--gold);">
                    ...
                    <div style="margin-top: 15px; display: flex; gap: 20px;">
                        ...
                        <div><p style="font-size: 0.6rem; color: var(--slate);">Filled</p><p style="font-size: 0.85rem; font-weight: 800; color: #10b981;">118</p></div>
                ...
                <div class="glass-card" style="padding: 22px; border-radius: 14px; border-top: 3px solid #10b981;">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <div>
                            <p style="font-size: 0.7rem; color: #10b981; font-weight: 800; letter-spacing: 1px;">MBA</p>
                    ...
                    <div style="margin-top: 15px; display: flex; gap: 20px;">
                        ...
                        <div><p style="font-size: 0.6rem; color: var(--slate);">Filled</p><p style="font-size: 0.85rem; font-weight: 800; color: #10b981;">54</p></div>
    ...
    "Exams": () => `
        <div class="view-header">
            ...
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 20px; border-radius: 12px; display: flex; gap: 15px; border: 1px solid var(--glass-border);">
                ...
                <button class="login-btn" style="width: auto; padding: 8px 20px; font-size: 0.75rem;"><i data-lucide="upload" style="width:14px; height:14px; margin-right:4px;"></i> UPLOAD_MARKS_BULK</button>
                <button class="login-btn action-trigger" data-action="hall_ticket" style="width: auto; padding: 8px 20px; font-size: 0.75rem; background: var(--gold); color: white;">GEN_HALL_TICKETS</button>
            </div>
        </div>

        <div class="kpi-grid" style="margin-top: 30px;">
            <div class="kpi-card"><span class="kpi-label">Papers Digitized</span><span class="kpi-val">100%</span></div>
            <div class="kpi-card"><span class="kpi-label">Evaluation</span><span class="kpi-val" style="color: var(--gold);">82.4%</span></div>
    ...
    "Fees": () => `
        <div class="view-header">
            ...
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 20px; border-radius: 12px; display: flex; gap: 15px; border: 1px solid var(--glass-border);">
                ...
                <button class="login-btn" style="width: auto; padding: 8px 20px; font-size: 0.75rem; background: var(--gold); color: white;"><i data-lucide="file-text" style="width:14px; height:14px; margin-right:4px;"></i> BULK_RECEIPTS</button>
            </div>
        </div>
    ...
    "Finance": () => `
        <div class="view-header">
            ...
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 20px; border-radius: 12px; display: flex; gap: 15px; border: 1px solid var(--glass-border);">
                ...
                <button class="login-btn" style="width: auto; padding: 8px 20px; font-size: 0.75rem; background: var(--gold); color: white;"><i data-lucide="layout-dashboard" style="width:14px; height:14px; margin-right:4px;"></i> EXPORT_BALANCE_SHEET</button>
            </div>
        </div>

        <div class="kpi-grid" style="margin-top: 30px;">
            <div class="kpi-card glass-card"><span class="kpi-label">Institutional Net Worth</span><span class="kpi-val">$24.5M</span></div>
            <div class="kpi-card glass-card"><span class="kpi-label">Operating Margin</span><span class="kpi-val" style="color: #10b981;">22.4%</span></div>
            <div class="kpi-card glass-card"><span class="kpi-label">Institutional Reserve</span><span class="kpi-val" style="color: var(--gold);">$4.8M</span></div>
        </div>
