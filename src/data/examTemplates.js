export const examViewTemplates = {
    "Dashboard": (role = "Exams") => `
        <div class="view-header">
            ...
            <p style="color: var(--slate); font-size: 0.8rem; margin-top: 5px;">Sovereign Assessment Engine &bull; Cycle 2026-A &nbsp;|&nbsp; <span style="color: #10b981;">Integrity Shield: ACTIVE</span></p>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 30px; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 15px;">
            <div class="kpi-card glass-card">
                ...
                <span class="kpi-val" style="color: #10b981;">68.4%</span>
                <div class="status-pill success" style="margin-top: 5px;">↑ 12.5% Target Lead</div>
            </div>
            <div class="kpi-card glass-card">
            ...
            <div class="kpi-card glass-card">
                ...
                <span class="kpi-val" style="color: #ef4444;">02</span>
                <div class="status-pill danger" style="margin-top: 5px;">Rapid Response Active</div>
            </div>
            <div class="kpi-card glass-card">
                <span class="kpi-label">Hall Readiness</span>
                <span class="kpi-val" style="color: var(--white);">100%</span>
                <div class="status-pill success" style="margin-top: 5px;">42 Centers Synced</div>
            </div>
            <div class="kpi-card glass-card">
            ...
            <div class="glass-card">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
                    ...
                    <div style="display:flex; gap:10px;">
                        <span style="font-size:0.6rem; color:#10b981;">● Verified</span>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.65rem; margin-bottom: 5px;">
                            <span style="font-weight: 700;">CS & Engineering</span><span style="color: #10b981; font-weight: 800;">82%</span>
                        </div>
                        <div style="height: 6px; background: rgba(15, 23, 42, 0.05); border-radius: 3px; overflow: hidden; border: 1px solid rgba(16, 185, 129, 0.2);">
                    ...
                    <div>
                        <div style="display: flex; justify-content: space-between; font-size: 0.65rem; margin-bottom: 5px;">
                            <span style="font-weight: 700;">MBA School of Business</span><span style="color: #10b981; font-weight: 800;">91%</span>
                        </div>
                        <div style="height: 6px; background: rgba(255,255,255,0.05); border-radius: 3px; overflow: hidden; border: 1px solid rgba(16, 185, 129, 0.2);">
                            <div style="width: 91%; height: 100%; background: #10b981; box-shadow: 0 0 10px rgba(16, 185, 129, 0.3);"></div>
                        </div>
                    </div>
                </div>
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; padding: 10px; background: rgba(255,255,255,0.02); border-radius: 8px;">
                        <div><p style="font-size: 0.65rem; color: var(--slate);">Digital Paper Release</p><p style="font-size: 0.8rem; font-weight: 700; color: #10b981;">SECURE</p></div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 20px;" class="slide-up">
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="height: 180px; position: relative;">
                    <svg width="100%" height="100%" viewBox="0 0 400 150">
                        <polyline fill="none" stroke="#10b981" stroke-width="2" points="0,140 50,110 100,120 150,80 200,90 250,50 300,70 350,30 400,40" />
                        <path d="M0,140 50,110 100,120 150,80 200,90 250,50 300,70 350,30 400,40 V150 H0 Z" fill="rgba(16, 185, 129, 0.1)" />
                    </svg>
            ...
            <div style="background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
                <div style="padding: 18px 22px; border-bottom: 1px solid var(--glass-border); display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <span style="font-size: 0.6rem; color: #10b981;">LIVE SYNC</span>
                </div>
                <table class="data-table" style="font-size: 0.65rem;">
                    ...
                    <tbody>
                        <tr><td>Main Campus Block-A</td><td>450</td><td>442</td><td style="color:#ff3b3b;">08</td><td><span style="color:#10b981;">GREEN</span></td></tr>
                        <tr><td>South Wing Center-2</td><td>310</td><td>308</td><td>02</td><td><span style="color:#10b981;">GREEN</span></td></tr>
                        <tr><td>Technical Hub-4</td><td>110</td><td>110</td><td>00</td><td><span style="color:#10b981;">GREEN</span></td></tr>
    ...
    "Exams": (role = "Exams") => `
        <div class="view-header" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button class="login-btn action-trigger" data-action="new_exam" style="width: auto; padding: 10px 25px; background: var(--gold); color: white; font-weight: 800; border: none;">+ SCHEDULE_EXAM</button>
        </div>
            ...
            <table class="data-table" style="font-size: 0.72rem;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><button class="login-btn action-trigger" data-action="view_grading" style="padding:4px 8px;font-size:0.58rem;width:auto;background:#10b981;color:white;">EVALUATE</button></td>
                    </tr>
                    <tr>
                        <td>CS6005</td>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-top: 25px;" class="slide-up">
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="height: 200px; display: flex; align-items: flex-end; gap: 15px; padding-bottom: 20px;">
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                        <div style="width: 100%; height: 75%; background: #10b981; border-radius: 4px; position: relative;">
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column; align-items: center; gap: 8px;">
                        <div style="width: 100%; height: 85%; background: #10b981; border-radius: 4px; position: relative;">
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <button class="login-btn action-trigger" data-action="publish_results" style="text-align: left; padding: 15px; font-size: 0.75rem; background: var(--gold); color: white; font-weight: 800;">🚀 PUBLISH SEMESTER RESULTS</button>
                </div>
            </div>
        </div>
    `
