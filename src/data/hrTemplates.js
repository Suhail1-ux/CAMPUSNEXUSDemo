...
export const hrViewTemplates = {
    "Dashboard": (role = "HR") => `
        <div class="view-header">
            ...
            <p style="color: var(--slate); font-size: 0.8rem; margin-top: 5px;">Institutional Workforce Telemetry &nbsp;|&nbsp; <span style="color: #64ffda;">Resource Node Sync: 100%</span></p>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 30px;">
            <div class="kpi-card">
                ...
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">↑ 2.4% vs Prev Quarter</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Open Requisitions</span>
                <span class="kpi-val" style="color: var(--gold);">14</span>
                <div style="font-size: 0.65rem; color: var(--slate); font-weight: 700;">8 High Priority Nodes</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Attrition Pulse</span>
                <span class="kpi-val" style="color: #64ffda;">4.2%</span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">Below 5% Industry Avg</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Resource Utilization</span>
                <span class="kpi-val">96.8%</span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">Optimal Load Distribution</div>
            </div>
        </div>
            ...
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
                    ...
                    <div style="display: flex; gap: 15px;">
                        ...
                        <span style="font-size: 0.7rem; color: var(--slate);"><i style="color: #64ffda; margin-right: 5px;">●</i>Onboarded</span>
                    </div>
                </div>
                <div style="height: 250px; background: rgba(0,0,0,0.2); border-radius: 12px; border: 1px dashed var(--glass-border); position: relative; overflow: hidden; display: flex; align-items: flex-end;">
                    <svg width="100%" height="100%" viewBox="0 0 1000 300" preserveAspectRatio="none" style="position: absolute; bottom: 0; left: 0;">
                        ...
                        <path d="M0,270 Q250,230 500,260 T1000,240 V300 H0 Z" fill="rgba(100,255,218,0.05)" stroke="#64ffda" stroke-width="2" opacity="0.6" />
                    </svg>
                    <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center;">
                        ...
                        <div style="font-size: 0.65rem; color: var(--gold); letter-spacing: 3px; font-weight: 800;">ONBOARDING_VELOCITY_NODE</div>
                    </div>
                </div>
            </div>
            
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                <h3 style="font-size: 0.9rem; font-weight: 700; margin-bottom: 20px;">HR Critical Actions</h3>
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div class="action-card action-trigger" data-action="payroll_run" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:15px; background:rgba(255,255,255,0.03); border-radius:10px; border:1px solid var(--glass-border);">
                        <i style="font-size:1.5rem; color:var(--gold);">🏦</i>
                        <div>
                            <span style="font-size:0.75rem; font-weight:800; display:block;">Execute Payroll Cycle</span>
                            <span style="font-size:0.6rem; color:var(--slate);">FEB 2026 Disbursement</span>
                        </div>
                    </div>
                    <div class="action-card action-trigger" data-action="gen_payslip" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:15px; background:rgba(255,255,255,0.03); border-radius:10px; border:1px solid var(--glass-border);">
                        <i style="font-size:1.5rem; color:var(--gold);">📄</i>
                        <div>
                            <span style="font-size:0.75rem; font-weight:800; display:block;">Export Payslip Batch</span>
                            <span style="font-size:0.6rem; color:var(--slate);">Encrypt and Dispatch Nodes</span>
                        </div>
                    </div>
                    <div class="action-card action-trigger" data-action="run_audit" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:15px; background:rgba(100,255,218,0.05); border-radius:10px; border:1px solid rgba(100,255,218,0.2);">
                        <i style="font-size:1.5rem; color:var(--gold);">🏛️</i>
                        <div>
                            <span style="font-size:0.75rem; font-weight:800; display:block; color:var(--gold);">Regulatory Compliance Pass</span>
    ...
    "Directory": () => `
        <div class="view-header">
            ...
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 20px; border-radius: 12px; display: flex; gap: 15px; border: 1px solid var(--glass-border);">
                ...
                <button class="login-btn action-trigger" data-action="export_excel" style="width: auto; padding: 8px 20px; font-size: 0.75rem; background: var(--gold); color: var(--navy-dark);">EXPORT_DIRECTORY</button>
            </div>
        </div>
        ...
        <div class="slide-up" style="margin-top: 25px; background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
            <table class="data-table" style="font-size: 0.75rem;">
                <thead>
                    <tr><th>Resource Node</th><th>Designation</th><th>Department</th><th>Tenure Sync</th><th>Salary Grade</th><th>Status</th><th>Actions</th></tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
    ...
    "Leave": () => `
        ...
        <div class="kpi-grid" style="margin-top: 25px;">
            <div class="kpi-card"><span class="kpi-label">On Leave Today</span><span class="kpi-val">12</span><div style="font-size:0.6rem; color:var(--slate);">0.9% of Total Workforce</div></div>
            <div class="kpi-card"><span class="kpi-label">Pending Approvals</span><span class="kpi-val" style="color: #ffab00;">8</span><div style="font-size:0.6rem; color: #ffab00;">Requires HR Clearance</div></div>
            <div class="kpi-card"><span class="kpi-label">Resource Health</span><span class="kpi-val" style="color: #64ffda;">99.1%</span><div style="font-size:0.6rem; color: #64ffda;">Sufficient Coverage</div></div>
        </div>
        ...
        <div class="slide-up" style="margin-top: 25px; background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
            ...
            <table class="data-table" style="font-size: 0.75rem;">
                <thead>
                    <tr><th>Resource</th><th>Type</th><th>Duration</th><th>Period</th><th>Reason Node</th><th>Actions</th></tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                        ...
                        <td>
                            <div style="display: flex; gap: 5px;">
                                <button class="login-btn action-trigger" data-action="leave_approve" style="padding:4px 10px; font-size:0.6rem; width:auto; background:rgba(100,255,218,0.1); color:#64ffda; border:1px solid #64ffda;">APPROVE</button>
    ...
    "Payroll": () => `
        ...
        <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 20px; margin-top: 30px;" class="slide-up">
            <div style="background: var(--glass); padding:30px; border-radius:16px; border:1px solid var(--glass-border); text-align:center;">
                <h4 style="font-size: 1.2rem; color: var(--white); font-weight: 900; margin-bottom: 10px;">FEB 2026 DISBURSEMENT_NODE</h4>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 30px;">
                    ...
                    <div style="background: rgba(255,255,255,0.03); padding: 20px; border-radius: 12px; border: 1px solid var(--glass-border);">
                        <span style="font-size: 0.6rem; color: #64ffda; display: block; text-transform: uppercase;">Faculty Count</span>
                        <span style="font-size: 1.6rem; font-weight: 800; color: var(--white);">1,250</span>
                    </div>
                </div>

                <button class="login-btn action-trigger" data-action="payroll_run" style="width: 100%; height: 50px; font-size: 0.9rem; background: var(--gold); color: var(--navy-dark); font-weight: 900; letter-spacing: 2px;">EXECUTE_GLOBAL_DISBURSEMENT_PASS</button>
                <button class="login-btn action-trigger" data-action="gen_payslip" style="margin-top: 15px; width: 100%; border-color: rgba(255,255,255,0.1);">⏬ EXPORT_PAYSLIP_BATCH_FOR_LEDGER</button>
            </div>
                ...
                <div style="background: var(--glass); padding:25px; border-radius:16px; border:1px solid var(--glass-border);">
                    ...
                    <div style="display:flex; flex-direction:column; gap:12px;">
                        <div style="font-size:0.65rem; display:flex; align-items:center; gap:10px;">
                            <i style="color:#64ffda;">✔</i>
                            <span>All attendance nodes synchronized</span>
                        </div>
                        <div style="font-size:0.65rem; display:flex; align-items:center; gap:10px;">
                            <i style="color:#64ffda;">✔</i>
                ...
                <div style="background: var(--glass); padding:25px; border-radius:16px; border:1px solid var(--glass-border);">
                    ...
                    <div style="height: 120px; width: 100%; position: relative; display: flex; align-items: center; justify-content: center;">
                        <svg width="100" height="100" viewBox="0 0 42 42">
                            ...
                            <circle cx="21" cy="21" r="15.915" fill="transparent" stroke="#64ffda" stroke-width="3" stroke-dasharray="20 80" stroke-dashoffset="55"></circle>
                        </svg>
    ...
    "Reports": () => `
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-top: 25px;" class="slide-up">
            <div class="kpi-card">
                ...
                <div style="font-size: 0.6rem; color: #64ffda;">Optimal Stability</div>
            </div>
            <div class="kpi-card">
            ...
            <div class="kpi-card">
                ...
                <div style="font-size: 0.6rem; color: #64ffda;">Fast-track Node</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Compliance Rank</span>
                <span class="kpi-val">AAA</span>
                <div style="font-size: 0.6rem; color: #64ffda;">Node Integrity: 100%</div>
            </div>
        </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                <div>
                    <div style="display: flex; justify-content: space-between; font-size: 0.7rem; margin-bottom: 8px;">
                        ...
                        <span style="font-weight: 800;">450 Nodes (36%)</span>
                    </div>
                ...
                <div>
                    <div style="display: flex; justify-content: space-between; font-size: 0.7rem; margin-bottom: 8px;">
                        ...
                        <span style="font-weight: 800;">320 Nodes (25%)</span>
                    </div>
                    <div style="height: 6px; background: rgba(255,255,255,0.05); border-radius: 3px; overflow: hidden;">
                        <div style="width: 25%; height: 100%; background: #64ffda;"></div>
                    </div>
                </div>
            </div>
