...
export const accountViewTemplates = {
    "Dashboard": (role = "Accounts") => `
        <div class="view-header">
            ...
            <p style="color: var(--slate); font-size: 0.8rem; margin-top: 5px;">Institutional Financial Telemetry &nbsp;|&nbsp; <span style="color: #64ffda;">Ledger Node Sync: 100%</span></p>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 30px;">
            ...
            <div class="kpi-card">
                ...
                <span class="kpi-val" style="color: #ff4d4d;">$102.4K</span>
                <div style="font-size: 0.65rem; color: #ffab00; font-weight: 700;">Recovery Velocity: MODERATE</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Institutional Liquidity</span>
                <span class="kpi-val" style="color: #64ffda;">$4.8M</span>
            ...
            <div class="kpi-card">
                ...
                <span class="kpi-val">99.9%</span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">Optimal Ledger Integrity</div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 25px; margin-top: 25px;" class="slide-up">
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="height: 220px; background: rgba(0,0,0,0.2); border-radius: 12px; border: 1px dashed var(--glass-border); position: relative; overflow: hidden; display: flex; align-items: flex-end; padding: 0 10px;">
                    <svg width="100%" height="80%" viewBox="0 0 1000 200" preserveAspectRatio="none">
                        ...
                        <path d="M0,180 Q100,160 200,170 T400,130 T600,90 T800,70 T1000,40 V200 H0 Z" fill="rgba(184,134,11,0.1)" />
                        <line x1="0" y1="180" x2="1000" y2="40" stroke="rgba(255,255,255,0.05)" stroke-dasharray="5,5" />
                    </svg>
                ...
                <div style="margin-top: 25px;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(15, 1fr); gap: 6px;">
                        ${Array(30).fill(0).map((_, i) => `
                            <div style="aspect-ratio: 1; border-radius: 2px; background: rgba(100,255,218, ${0.1 + (Math.random() * 0.8)}); cursor: help;" title="Day ${i + 1}: $${(Math.random() * 40).toFixed(1)}K"></div>
                        `).join('')}
                    </div>
                </div>
            </div>
            ...
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 12px;">
                    <div class="action-card action-trigger" data-action="fee_demand_gen" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:12px; background:rgba(184,134,11,0.05); border-radius:10px; border:1px solid var(--gold);">
                        <i style="font-size:1.2rem; color:var(--gold);">📩</i>
                        <div>
                    ...
                    <div class="action-card action-trigger" data-action="export_master_ledger" style="cursor:pointer; display:flex; align-items:center; gap:12px; padding:12px; background:rgba(100,255,218,0.05); border-radius:10px; border:1px solid rgba(100,255,218,0.2);">
                        <i style="font-size:1.2rem; color:var(--gold);">🏛️</i>
                        <div>
                            <span style="font-size:0.7rem; font-weight:800; display:block; color:var(--gold);">Financial Integrity Audit</span>
                            <span style="font-size:0.6rem; color:var(--slate);">Sovereign Node Compliance</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-top: 30px; border-top: 1px solid var(--glass-border); padding-top: 20px;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 10px;">
                        <div style="font-size: 0.65rem; display: flex; align-items: center; gap: 8px;">
                            <i style="color: #ff4d4d;">⚠️</i>
                            <span>12 Vouchers Pending Approval</span>
                        </div>
                        <div style="font-size: 0.65rem; display: flex; align-items: center; gap: 8px;">
                            <i style="color: #ffab00;">⏳</i>
    ...
    "Fees": () => `
        <div class="view-header">
            ...
            <div class="filters-bar" style="margin-top: 20px; background: var(--glass); padding: 20px; border-radius: 12px; display: flex; gap: 15px; border: 1px solid var(--glass-border);">
                ...
                <button class="login-btn action-trigger" data-action="fee_demand_gen" style="width: auto; padding: 8px 20px; font-size: 0.75rem; background: var(--gold); color: var(--navy-dark);">BULK_BILLING_RUN</button>
            </div>
        </div>

        <div style="display: flex; gap: 10px; margin-top: 20px;">
            <button class="login-btn" style="width: auto; padding: 5px 15px; font-size: 0.6rem; background: rgba(100,255,218,0.1); border: 1px solid #64ffda;">RECONCILE_SELECTED</button>
        ...
        <div class="slide-up" style="margin-top: 15px; background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
            <div style="padding: 18px 22px; border-bottom: 1px solid var(--glass-border); display: flex; justify-content: space-between; align-items: center;">
                <h3 style="font-size: 0.9rem; font-weight: 700; color: var(--gold);">Receivable Ledger Node</h3>
            ...
            <table class="data-table" style="font-size: 0.75rem;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Tuition Node</td>
                        <td>$4,500</td>
                        <td style="color:#64ffda;">$3,250</td>
                    ...
                    <tr>
                        ...
                        <td>$6,200</td>
                        <td style="color:#64ffda;">$6,200</td>
    ...
    "Finance": () => `
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; text-align: center;">
                    ...
                    <div>
                        <svg width="80" height="80" viewBox="0 0 100 100">
                            <circle cx="50" cy="50" r="40" fill="none" stroke="rgba(255,255,255,0.05)" stroke-width="8" />
                            <circle cx="50" cy="50" r="40" fill="none" stroke="#64ffda)" stroke-width="8" stroke-dasharray="110, 251" stroke-linecap="round" />
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 15px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--glass-border); padding-bottom: 10px;">
                        ...
                        <span style="font-size: 0.8rem; font-weight: 900; color: #64ffda;">$4.82M</span>
                    </div>
                    <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid var(--glass-border); padding-bottom: 10px;">
        ...
        <div class="slide-up" style="margin-top: 25px; background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
            <div style="padding: 18px 22px; border-bottom: 1px solid var(--glass-border); display: flex; justify-content: space-between; align-items: center;">
                 ...
                 <button class="login-btn action-trigger" data-action="export_master_ledger" style="width:auto; padding:5px 15px; font-size:0.6rem;">DOWNLOAD_XLS_NODES</button>
            </div>
            <table class="data-table" style="font-size: 0.75rem;">
                <thead>
                    <tr><th>Tx Hash</th><th>Category</th><th>Beneficiary Node</th><th>Amount</th><th>Timestamp</th><th>Status</th></tr>
                </thead>
                <tbody>
                    <tr><td>0x88A1...F21</td><td>Academic Payroll</td><td>Faculty Disb. Node</td><td>$840,000</td><td>Today, 10:45 AM</td><td><span class="status-pill status-verified">SETTLED</span></td></tr>
                    ...
                    <tr><td>0x88C3...A98</td><td>Marketing Node</td><td>Google Ad Engine</td><td>$4,500</td><td>Feb 20, 2026</td><td><span class="status-pill status-pending">IN_TRANSIT</span></td></tr>
                </tbody>
            </table>
        </div>
    `,
    ...
    "Reports": () => `
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-top: 30px;" class="slide-up">
            <div class="kpi-card action-trigger" data-action="export_pdf" style="cursor:pointer; border: 1px solid var(--glass-border);">
                <i style="font-size: 1.5rem; display: block; margin-bottom: 15px;">📊</i>
                ...
                <div style="margin-top:10px; font-size:0.55rem; color:var(--gold);">NODES: 1,244 Sync</div>
            </div>
            <div class="kpi-card action-trigger" data-action="export_excel" style="cursor:pointer; border: 1px solid var(--glass-border);">
                ...
                <div style="margin-top:10px; font-size:0.55rem; color:#ff4d4d;">CRITICAL: 104 Nodes</div>
            </div>
            <div class="kpi-card action-trigger" data-action="export_pdf" style="cursor:pointer; border: 1px solid var(--glass-border);">
                <i style="font-size: 1.5rem; display: block; margin-bottom: 15px;">🏛️</i>
            ...
            <div class="kpi-card action-trigger" data-action="export_master_ledger" style="cursor:pointer; border: 1px solid var(--glass-border);">
                ...
                <div style="margin-top:10px; font-size:0.55rem; color:#64ffda;">COMPLIANT: 100%</div>
            </div>
        </div>
        ...
        <div style="margin-top: 30px; background: rgba(100,255,218,0.05); padding: 25px; border-radius: 16px; border: 1px dashed rgba(100,255,218,0.3);">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h3 style="font-size: 1rem; font-weight: 900; color: #64ffda;">Fiscal Integrity Report 2026</h3>
                    <p style="font-size: 0.75rem; color: var(--slate); margin-top: 5px;">Automated node-level verification of all institutional financial transactions.</p>
                </div>
