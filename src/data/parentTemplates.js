export const parentViewTemplates = {
    "Dashboard": (role = "Parent") => `
        <div class="view-header">
            ...
            <p style="color: var(--slate); font-size: 0.8rem; margin-top: 5px;">Ward: Aarav Malhotra (#CN-9822) &nbsp;|&nbsp; <span style="color: #64ffda;">Sovereign Node Sync: Active</span></p>
        </div>
        ...
        <div class="kpi-grid" style="margin-top: 30px;">
            <div class="kpi-card">
                ...
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">↑ 0.12 vs Semester 05</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Attendance Registry</span>
                <span class="kpi-val" style="color: #64ffda;">98.5%</span>
                <div style="font-size: 0.65rem; color: #64ffda; font-weight: 700;">Regular Domain Presence</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Current Liability</span>
                <span class="kpi-val" style="color: #ff4d4d;">$1,250</span>
                <div style="font-size: 0.65rem; color: #ffab00; font-weight: 700;">Due: Feb 25, 2026</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Institutional Rank</span>
                <span class="kpi-val">#02</span>
                <div style="font-size: 0.65rem; color: var(--gold); font-weight: 700;">Top Decile Merit Node</div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 25px; margin-top: 25px;" class="slide-up">
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border);">
                ...
                <div style="height: 220px; background: rgba(0,0,0,0.2); border-radius: 12px; border: 1px dashed var(--glass-border); position: relative; overflow: hidden; display: flex; align-items: flex-end;">
                    <svg width="100%" height="100%" viewBox="0 0 1000 300" preserveAspectRatio="none" style="position: absolute; bottom: 0; left: 0;">
                        ...
                        <path d="M0,240 Q250,210 500,230 T1000,200 V300 H0 Z" fill="rgba(100,255,218,0.05)" stroke="rgba(100,255,218,0.3)" stroke-width="2" stroke-dasharray="5,5" />
                    </svg>
                    <div style="position: absolute; top: 20px; left: 20px;">
                        <div style="font-size: 0.6rem; color: var(--gold); letter-spacing: 2px;">ACADEMIC_VELOCITY_IDX</div>
                        <div style="font-size: 1.8rem; font-weight: 900; color: white; margin-top: 5px;">9.42 / 10</div>
                    </div>
                </div>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                    <h3 style="font-size: 0.85rem; font-weight: 700; color: var(--gold); margin-bottom: 20px;">Primary Faculty Node</h3>
                    <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                        <div style="width:50px; height:50px; border-radius:12px; background:rgba(184,134,11,0.1); border:1px solid var(--gold); display:flex; align-items:center; justify-content:center; font-size:1.5rem;">👨‍🏫</div>
                        <div>
                ...
                <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border); border-left: 4px solid #ff4d4d;">
                    <h3 style="font-size: 0.85rem; font-weight: 700; color: #ff4d4d; margin-bottom: 5px;">Action Required</h3>
                    <p style="font-size: 0.65rem; color: var(--slate); margin-bottom: 15px;">Hostel & Lab Dues Outstanding</p>
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <span style="font-size: 1.1rem; font-weight: 900; color: white;">$1,250</span>
                        <button class="login-btn action-trigger" data-action="pay_fees" style="width: auto; padding: 6px 15px; font-size: 0.65rem; background: var(--gold); color: var(--navy-dark); border: none;">PAY_NOW</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    "Attendance": (role = "Parent") => `
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 30px;" class="slide-up">
            <div class="kpi-card">
                ...
                <span class="kpi-val" style="color: #64ffda;">242</span>
                <div style="font-size: 0.6rem; color: #64ffda;">98.5% Consistency</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Lectures Missed</span>
                <span class="kpi-val" style="color: #ff4d4d;">04</span>
                <div style="font-size: 0.6rem; color: #ff4d4d;">Authorized Nodes</div>
            </div>
            <div class="kpi-card">
                <span class="kpi-label">Average Load</span>
                <span class="kpi-val">6 hr/day</span>
        ...
        <div class="slide-up" style="margin-top: 25px; background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
            <table class="data-table" style="font-size: 0.75rem;">
                <thead>
                    <tr><th>Subject Node</th><th>Required %</th><th>Current %</th><th>Buffer</th><th>Status</th></tr>
                </thead>
                <tbody>
                    <tr>
                        <td style="font-weight: 800;">Advanced Algorithms</td>
                        <td>75%</td>
                        <td><span style="color: #64ffda; font-weight: 900;">100%</span></td>
                        <td style="color: var(--slate);">+6 Lectures</td>
                        <td><span class="status-pill status-verified" style="background: rgba(100,255,218,0.1); color: #64ffda; border-color: #64ffda;">EXEMPT</span></td>
                    </tr>
                    <tr>
        ...
        <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 25px; margin-top: 30px;" class="slide-up">
            <div style="background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
                ...
                <table class="data-table" style="font-size: 0.72rem;">
                    ...
                    <tbody>
                        <tr><td>Semester 05</td><td>9.50</td><td>9.42</td><td style="color:#64ffda; font-weight:800;">EXCELLENT</td><td><span class="status-pill status-verified">NODE_SYNC</span></td></tr>
                        <tr><td>Semester 04</td><td>9.33</td><td>9.30</td><td style="color:#64ffda; font-weight:800;">EXCELLENT</td><td><span class="status-pill status-verified">NODE_SYNC</span></td></tr>
                        <tr><td>Semester 03</td><td>9.58</td><td>9.28</td><td style="color:#64ffda; font-weight:800;">EXCELLENT</td><td><span class="status-pill status-verified">NODE_SYNC</span></td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 20px;">
                <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border);">
                    ...
                    <div style="padding: 18px; background: rgba(255,255,255,0.03); border-radius: 12px; border-left: 4px solid var(--gold);">
                        ...
                        <button class="login-btn action-trigger" data-action="hall_ticket" style="margin-top: 15px; width: 100%; border-color: rgba(255,255,255,0.1);">ACCESS_EXAM_NODE</button>
                    </div>
                </div>
                ...
                <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border); text-align: center;">
                    ...
                    <div style="font-size: 2.2rem; font-weight: 900; color: white; margin-top: 10px;">68%</div>
                    <div style="height: 4px; background: rgba(255,255,255,0.05); margin-top: 15px; border-radius: 2px;">
                        <div style="width: 68%; height: 100%; background: #64ffda;"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    "Fees": (role = "Parent") => `
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; margin-top: 30px;" class="slide-up">
            <div class="kpi-card">
                ...
                <div style="font-size: 0.6rem; color: #64ffda;">YTD Verified Success</div>
            </div>
            ...
            <div class="kpi-card">
                ...
                <div style="font-size: 0.6rem; color: var(--gold);">Merit Node Tier-1</div>
            </div>
        </div>
        ...
        <div class="slide-up" style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 20px; margin-top: 25px;">
            <div style="background: var(--glass); border-radius: 16px; border: 1px solid var(--glass-border); overflow: hidden;">
                ...
                <table class="data-table" style="font-size: 0.72rem;">
                    <thead><tr><th>Ref_Node</th><th>Fiscal Nature</th><th>Execution Date</th><th>Node Value</th><th>Status</th></tr></thead>
                    <tbody>
                        <tr><td>#PX-0442</td><td>Tuition Installment (S2)</td><td>Jan 12, 2026</td><td>$4,500</td><td><span class="status-pill status-verified" style="background:#64ffda; color:var(--navy-dark);">COMMITTED</span></td></tr>
                        <tr><td>#PX-0443</td><td>Hostel/Infra Pass</td><td>Jan 14, 2026</td><td>$2,750</td><td><span class="status-pill status-verified" style="background:#64ffda; color:var(--navy-dark);">COMMITTED</span></td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div style="background: var(--glass); padding: 30px; border-radius: 16px; border: 1px solid var(--glass-border); background: linear-gradient(135deg, rgba(255,255,255,0.03) 0%, rgba(255,255,255,0.01) 100%);">
                ...
                <div style="background: rgba(0,0,0,0.2); padding: 20px; border-radius: 12px; border: 1px solid var(--glass-border); margin-bottom: 25px;">
                    ...
                    <div style="font-size: 0.65rem; color: #ffab00;">Note: Late fee node triggers in 48h.</div>
                </div>
                <button class="login-btn action-trigger" data-action="pay_fees" style="width: 100%; height: 50px; font-size: 0.9rem; background: var(--gold); color: var(--navy-dark); font-weight: 900; letter-spacing: 1px;">INITIALIZE_PAYMENT_GATEWAY</button>
                <p style="font-size:0.55rem; color:var(--slate); text-align:center; margin-top:20px;">256-bit AES Encryption Active | Transaction Node: 0x884Z</p>
            </div>
        </div>
    `,
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        ...
                        <div style="display: flex; gap: 12px; margin-top: 20px;">
                            <button class="login-btn action-trigger" data-action="rsvp" style="width: auto; padding: 10px 25px; font-size: 0.75rem; background: var(--gold); color: var(--navy-dark);">SECURE_RSVP_SLOT</button>
            ...
            <div style="background: var(--glass); padding: 25px; border-radius: 16px; border: 1px solid var(--glass-border); border-left: 5px solid #64ffda;">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        ...
                        <p style="font-size: 0.8rem; color: var(--slate); margin-top: 8px; line-height: 1.6;">Main Campus Hostel Alpha has successfully cleared the recursive institutional safety audit for Q1 2026. All nodes optimal.</p>
                    </div>
